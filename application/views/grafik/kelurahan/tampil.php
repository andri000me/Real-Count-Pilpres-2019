<div class="row">
		...
		<li class="active">Suara Kelurahan</li>
	</ol>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <?php echo anchor('Grafik_kelurahan/grafik_kel','PILIH KELURAHAN LAIN',array('class'=>'btn btn-default btn-sm'))?>
...
<div class="row" style="text-align: center;">
  ...
  <div class="col-md-6">
      ...
      <div class="suara">
        <span>Jumlah Suara = <?php  foreach ($idKel->result() as $r) { ?>
                            <?php echo $r->suara1?>
                           <?php } ?></span>                  
      </div>
      <!-- 
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKel->result() as $r) { ?>
                            <?php echo $r->suara1?>,
                            <?php echo $r->suara2?>
                           <?php } ?>],
            backgroundColor: [
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKeldpd->result() as $s) { ?>
                            <?php echo $s->suara1?>,
                            <?php echo $s->suara2?>,
                            <?php echo $s->suara3?>,
                            <?php echo $s->suara4?>,
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKeldprri->result() as $s) { ?>
                            <?php echo $s->caleg_1?>,
                            <?php echo $s->caleg_2?>,
                            <?php echo $s->caleg_3?>,
                            <?php echo $s->caleg_4?>,
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKeldprdprov->result() as $s) { ?>
                            <?php echo $s->caleg_1?>,
                            <?php echo $s->caleg_2?>,
                            <?php echo $s->caleg_3?>,
                            <?php echo $s->caleg_4?>,
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKeldprdkabkota->result() as $s) { ?>
                            <?php echo $s->caleg_1?>,
                            <?php echo $s->caleg_2?>,
                            <?php echo $s->caleg_3?>,
                            <?php echo $s->caleg_4?>,
