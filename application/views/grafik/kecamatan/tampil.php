                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <?php echo anchor('Grafik_tes/grafik_kec','PILIH KECAMATAN LAIN',array('class'=>'btn btn-default btn-sm'))?>
...
<div class="row" style="text-align: center;">
  ...
  <div class="col-md-6">
      ...
      <div class="suara">
        <span>Jumlah Suara = <?php  foreach ($idKec->result() as $r) { ?>
                            <?php echo $r->suara1?>
                           <?php } ?></span>                  
      </div>
      <!-- 
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKec->result() as $r) { ?>
                            <?php echo $r->suara1?>,
                            <?php echo $r->suara2?>
                           <?php } ?>],
            backgroundColor: [
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKecdpd->result() as $s) { ?>
                            <?php echo $s->suara1?>,
                            <?php echo $s->suara2?>,
                            <?php echo $s->suara3?>,
                            <?php echo $s->suara4?>,
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKecdprri->result() as $s) { ?>
                            <?php echo $s->caleg_1?>,
                            <?php echo $s->caleg_2?>,
                            <?php echo $s->caleg_3?>,
                            <?php echo $s->caleg_4?>,
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKecdprdprov->result() as $s) { ?>
                            <?php echo $s->caleg_1?>,
                            <?php echo $s->caleg_2?>,
                            <?php echo $s->caleg_3?>,
                            <?php echo $s->caleg_4?>,
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# jumlah suara',
            data: [<?php $no=1; foreach ($idKecdprdkabkota->result() as $s) { ?>
                            <?php echo $s->caleg_1?>,
                            <?php echo $s->caleg_2?>,
                            <?php echo $s->caleg_3?>,
                            <?php echo $s->caleg_4?>,
