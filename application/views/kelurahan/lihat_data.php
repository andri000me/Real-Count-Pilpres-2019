  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="kelurahan/post" method="POST">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php $no=1; foreach ($record->result() as $r) { ?>
                                            <tr class="gradeU">
                                               <td><?php echo $no?></td>
                                                <td><?php echo $r->id_kelurahan?></td>
                                               <td><?php echo $r->nama?></td>
<?php  $kecamatan = $this->model_kelurahan->getKecamatan($r->id_kec)->row_array();
      ?>   
                                               <td><?php echo $kecamatan['nama']?></td>
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a title="Edit" class="btn btn-default" href="<?php echo site_url('kelurahan/edit/'.$r->id_kelurahan);?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                    
                                                    <a title="Hapus" class="btn btn-default" href="<?php echo site_url('kelurahan/delete/'.$r->id_kelurahan);?>"
