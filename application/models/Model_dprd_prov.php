<?php 
class Model_dprd_prov extends CI_Model{
    ...
    function tampil_data(){
        return $this->db->get('tb_suara_dprd_prov');
    }
    ...
    function post($data){
        $this->db->insert('tb_suara_dprd_prov',$data);
    }

    function get_one($id)
    {
        $param  =   array('id_suara'=>$id);
        return $this->db->get_where('tb_suara_dprd_prov',$param);
    }
    ...
    function edit($data,$id)
    {
        ...
        $this->db->update('tb_suara_dprd_prov',$data);
    }
    function delete($id)
    {
        $this->db->where('id_suara',$id);
        $this->db->delete('tb_suara_dprd_prov');
    }
